...
const Services = () => {
  return (
    <div className="lg: relative w-screen h-auto lg:h-auto mt-[150vh] lg:mt-[100vh] overflow-hidden gap-[100px]" style={{display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center"}}>
